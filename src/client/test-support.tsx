...
export function stubGateway(
  ...
  const base: ForgeCoreGateway & DevelopmentGateway = {
    ...
    getAuthoritativeMap: unused,
    getAuthoritativeCandidate: unused,
    listAuthoritativeTree: unused,
    locateAuthoritativeSlot: unused,
    listAuthoritativeMapRounds: unused,
    getAuthoritativeReviewSummary: unused,
    listAuthoritativeRounds: unused,
    getAuthoritativeSlotReview: unused,
    getAuthoritativeRelationReview: unused,
    listAuthoritativeFindings: unused,
    getAuthoritativeSealReadiness: unused,
    listAuthoritativeIssues: unused,
